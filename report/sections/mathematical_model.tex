...
Despite these measures, with the setting of step 3, the model does not solve to optimality in resonable time (within an hour), therefor, a 300-second time limit 
