...
Big-$M$ coefficient in the sequencing propagation constraint~\eqref{eq:seq},
where $M = |P|(d_{\max} + c)$ becomes non-binding for fractional arc
variables, inflating the search tree.
