...
For the SAA, the waiting-list~4 patient set is used, whose six documented OR
sessions carry session and position labels that fix the assignment for Steps 1 and 2 (and, for
Step~1, the sequencing). For assessing the solution quality of the stochastic programming solutions four patient sets are used  in total (waiting lists~4, 7, 10,
and~13), each spanning at least six sessions.
