...
Section~2 positions the work in the literature and introduces the SAA procedure.
Section~3 presents the mathematical model for Steps~1--3.
Section~4 describes the experimental setup and sampling evaluation.
Section~5 reports and discusses the results for Steps~1--4.
Section~6 extends the model to a three-stage blueprint for Step~5.
