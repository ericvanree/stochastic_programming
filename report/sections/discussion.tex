...
issue: it produces the negative Step-3 VSS
...
ignoring possible day-level correlation.

\paragraph{Further research.}
A sensitivity analysis over $\beta_5$ would expose the full trade-off between
...
inequalities would close the gap and turn the blueprint comparison into an exact
...
a risk-averse objective would bring the model closer to
